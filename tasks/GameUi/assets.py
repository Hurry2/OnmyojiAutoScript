...
class GameUiAssets: 
	...
	# 商店页面标志 
	I_CHECK_MALL = RuleImage(roi_front=(163,527,66,64), roi_back=(163,527,66,64), threshold=0.8, method="Template matching", file="./tasks/GameUi/page/page_check_mall.png")
	# 商店推荐页面标志 
