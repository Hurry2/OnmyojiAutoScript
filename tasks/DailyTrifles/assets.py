...
class DailyTriflesAssets: 
	...
	# Image Rule Assets
	# 进入庭院事务标志 
	I_ENTER_COURTYARD_AFFAIRS = RuleImage(roi_front=(990,372,25,30), roi_back=(446,349,593,220), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/dt/dt_enter_courtyard_affairs.png")
	# 庭院事务页面标志 
